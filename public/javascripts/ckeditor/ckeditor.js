...
(function () {
    if (!window.CKEDITOR)window.CKEDITOR = (function () {
        var a = {timestamp:'A7HG4HT', version:'3.4', revision:'5825', _:{}, status:'unloaded', basePath:(function () {
    ...
    (function () {
        ...
        var l = {createIterator:function () {
            var n = this, o = [], p;
            return{getNextRange:function () {
                p = p == undefined ? 0 : p + 1;
                var q = n[p];
                if (q && n.length > 1)if (!p)for (var r = n.length - 1; r > 0; r--)o.unshift(n[r].createBookmark(true)); else q.moveToBookmark(o.shift());
                return q;
            }};
    ...
    (function () {
        ...
        j.add(l, {availableLangs:{en:1, he:1}, init:function (n) {
            var o = this;
    ...
    (function () {
        var l = {table:1, ul:1, ol:1, blockquote:1, div:1}, m = {};
        e.extend(m, l, {tr:1, p:1, div:1, li:1});
        function n(s) {
        ...
        ;
        function o(s, t, u) {
            var v = s.config.useComputedState, w;
            v = v === undefined || v;
            if (v) {
                var x = s.getSelection(), y = x.getRanges();
        ...
        ;
        function p(s, t, u) {
            var v = s.getComputedStyle('direction'), w = s.getStyle('direction') || s.getAttribute('dir') || '';
            s.removeStyle('direction');
            if (w.toLowerCase() == t)s.removeAttribute('dir'); else s.setAttribute('dir', t);
        ...
        function r(s) {
            return function (t) {
                var u = t.getSelection(), v = t.config.enterMode, w = u.getRanges();
                if (w && w.length) {
                    ...
                    if (x) {
                        ...
                        var y = u.createBookmarks(), z, A;
                        for (var B = w.length - 1; B >= 0; B--) {
                            var C = [], D = new d.walker(w[B]);
                            D.evaluator = function (H) {
        ...
        ;
        j.add('bidi', {requires:['styles', 'button'], init:function (s) {
            var t = function (v, w, x, y) {
                s.addCommand(x, new a.command(s, {exec:y}));
                s.ui.addButton(v, {label:w, command:x});
            }, u = s.lang.bidi;
    ...
    (function () {
        ...
        var o = {exec:function (p) {
            var q = p.getCommand('blockquote').state, r = p.getSelection(), s = r && r.getRanges(true)[0];
            if (!s)return;
    ...
    (function () {
        var l = function (s, t) {
            var u = s.document, v = u.getBody(), w = false, x = function () {
                w = true;
            };
            v.on(t, x);
        ...
        n.prototype = {exec:function (s, t) {
            this.type == 'cut' && r(s);
            var u = m(s, this.type);
            if (!u)alert(s.lang.clipboard[this.type + 'Error']);
            return u;
        }};
        var o = {canUndo:false, exec:c ? function (s) {
            s.focus();
            ...
            switch (s.data.keyCode) {
                ...
                case 2000 + 45:
                    ...
                    if (!c && t.fire('beforepaste'))s.cancel(); else if (b.opera || b.gecko && b.version < 10900)t.fire('paste');
                    return;
                case 1000 + 88:
                case 2000 + 46:
                    var u = this;
        ...
        function q(s, t, u) {
            ...
            var x = this.getSelection(), y = new d.range(v), z = new h(t == 'text' ? 'textarea' : b.webkit ? 'body' : 'div', v);
            z.setAttribute('id', 'cke_pastebin');
            b.webkit && z.append(v.createText('\xa0'));
            v.getBody().append(z);
            z.setStyles({position:'absolute', top:x.getStartElement().getDocumentPosition().y + 'px', width:'1px', height:'1px', overflow:'hidden'});
        ...
        function r(s) {
            ...
            var t = s.getSelection(), u;
            if (t.getType() == 3 && (u = t.getSelectedElement())) {
                var v = t.getRanges()[0], w = s.document.createText('');
                w.insertBefore(u);
                v.setStartBefore(w);
                v.setEndAfter(u);
                t.selectRanges([v]);
        ...
        ;
        j.add('clipboard', {requires:['dialog', 'htmldataprocessor'], init:function (s) {
            s.on('paste', function (x) {
                var y = x.data;
                if (y.html)s.insertHtml(y.html); else if (y.text)s.insertText(y.text);
            }, null, null, 1000);
            ...
            function t(x, y, z, A) {
                var B = s.lang[y];
                s.addCommand(y, z);
                s.ui.addButton(x, {label:B, command:y});
            ...
            if (s.contextMenu) {
                ...
                s.contextMenu.addListener(function (x, y) {
                    ...
                    return{cut:!z && w('Cut'), copy:w('Copy'), paste:!z && (b.webkit ? 2 : w('Paste'))};
                });
            }
        }});
    })();
    ...
    j.contextMenu = e.createClass({$:function (l) {
        ...
        l.on('contextmenu', function (r) {
            ...
            s.preventDefault();
            var t = s.getTarget().getDocument().getDocumentElement(), u = s.$.clientX, v = s.$.clientY;
    ...
    (function () {
        function l(n) {
            var o = this.att, p = n && n.hasAttribute(o) && n.getAttribute(o) || '';
        ...
        function m() {
            ...
            if (n) {
                var p = this.att, q = this.getValue();
                if (q)n.setAttribute(p, q); else n.removeAttribute(p, q);
            }
        }

        ;
        j.add('dialogadvtab', {createAdvancedTab:function (n, o) {
            if (!o)o = {id:1, dir:1, classes:1, styles:1};
            var p = n.lang.common, q = {id:'advanced', label:p.advancedTab, title:p.advancedTab, elements:[
                {type:'vbox', padding:1, children:[]}
            ]}, r = [];
            if (o.id || o.dir) {
                if (o.id)r.push({id:'advId', att:'id', type:'text', label:p.id, setup:l, commit:m});
                if (o.dir)r.push({id:'advLangDir', att:'dir', type:'select', label:p.langDir, 'default':'', style:'width:110px', items:[
                    [p.notSet, ''],
                    [p.langDirLTR, 'ltr'],
                    [p.langDirRTL, 'rtl']
                ], setup:l, commit:m});
                q.elements[0].children.push({type:'hbox', widths:['50%', '50%'], children:[].concat(r)});
            }
            if (o.styles || o.classes) {
                r = [];
                if (o.id)r.push({id:'advStyles', att:'style', type:'text', label:p.styles, 'default':'', onChange:function () {
                ...
                if (o.classes)r.push({type:'hbox', widths:['45%', '55%'], children:[
                    {id:'advCSSClasses', att:'class', type:'text', label:p.cssClasses, 'default':'', setup:l, commit:m}
                ]});
                q.elements[0].children.push({type:'hbox', widths:['50%', '50%'], children:[].concat(r)});
            }
            return q;
    ...
    (function () {
        ...
        j.enterkey = {enterBlock:function (s, t, u, v) {
            ...
            if (!D && !E) {
                ...
                if (!G)G = w.createElement(z); else if (v && !G.is('li'))G.renameNode(z);
                var H = A.elementPath;
    ...
    j.add('forms', {init:function (l) {
        ...
        if (l.contextMenu) {
            l.contextMenu.addListener(function (p) {
                if (p && p.hasAscendant('form', true) && !p.isReadOnly())return{form:2};
            });
            l.contextMenu.addListener(function (p) {
                if (p && !p.isReadOnly()) {
                    var q = p.getName();
        ...
        l.on('doubleclick', function (p) {
            ...
            if (q.is('form'))p.data.dialog = 'form'; else if (q.is('select'))p.data.dialog = 'select'; else if (q.is('textarea'))p.data.dialog = 'textarea'; else if (q.is('img') && q.getAttribute('_cke_real_element_type') == 'hiddenfield')p.data.dialog = 'hiddenfield'; else if (q.is('input')) {
        ...
        var m = l.dataProcessor, n = m && m.htmlFilter, o = m && m.dataFilter;
        if (c)n && n.addRules({elements:{input:function (p) {
            var q = p.attributes, r = q.type;
            if (r == 'checkbox' || r == 'radio')q.value == 'on' && delete q.value;
        }}});
        if (o)o.addRules({elements:{input:function (p) {
    ...
    (function () {
        ...
        function n(Q) {
            var R = Q.children.length, S = Q.children[R - 1];
        ...
        function q(Q) {
            o(Q, true);
            if (p(Q))if (c)Q.add(new a.htmlParser.text('\xa0')); else Q.add(new a.htmlParser.element('br', {}));
        }
        ...
        var x = {elementNames:[
            ...
            var R = Q.parent;
            if (R && R.name == 'object') {
                var S = R.attributes.width, T = R.attributes.height;
        ...
        }}, attributes:{'class':function (Q, R) {
            return e.ltrim(Q.replace(/(?:^|\s+)cke_[^\s]*/g, '')) || false;
        }}, comment:function (Q) {
            if (Q.substr(0, m.length) == m) {
                if (Q.substr(m.length, 3) == '{C}')Q = Q.substr(m.length + 3); else Q = Q.substr(m.length);
        ...
        var B = /<(?:a|area|img|input)[\s\S]*?\s((?:href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+)))/gi, C = /(?:<style(?=[ >])[^>]*>[\s\S]*<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, D = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, E = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, F = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, G = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi;
        ...
        ;
        function P(Q, R) {
            var S = [], T = /<\!--\{cke_temp(comment)?\}(\d*?)-->/g, U = [/<script[\s\S]*?<\/script>/gi, /<noscript[\s\S]*?<\/noscript>/gi].concat(R);
        ...
        ;
        j.add('htmldataprocessor', {requires:['htmlwriter'], init:function (Q) {
        ...
        a.htmlDataProcessor.prototype = {toHtml:function (Q, R) {
            ...
            Q = J(Q);
            Q = O(Q);
            var T = a.htmlParser.fragment.fromHtml(Q, R), U = new a.htmlParser.basicWriter();
            T.writeHtml(U, this.dataFilter);
            Q = U.getHtml(true);
            Q = N(Q);
            return Q;
        }, toDataFormat:function (Q, R) {
            var S = this.writer, T = a.htmlParser.fragment.fromHtml(Q, R);
            S.reset();
    ...
    (function () {
        var l = {ol:1, ul:1}, m = d.walker.whitespaces(true), n = d.walker.bookmark(false, true);
        ...
        function p(t) {
            var C = this;
            var u = t.editor, v = t.data.path, w = v && v.contains(l);
        ...
        q.prototype = {exec:function (t) {
            ...
            function y(M) {
                ...
                if (u.useIndentClasses) {
                    var N = M.$.className.match(u.classNameRegex), O = 0;
                    if (N) {
                        N = N[1];
                        O = u.indentClassMap[N];
                    }
                    if (u.name == 'outdent')O--; else O++;
                    if (O < 0)return false;
                    O = Math.min(O, t.config.indentClasses.length);
                    O = Math.max(O, 0);
                    var P = e.ltrim(M.$.className.replace(u.classNameRegex, ''));
                    if (O < 1)M.$.className = P; else M.addClass(t.config.indentClasses[O - 1]);
                } else {
                    var Q = r(M), R = parseInt(M.getStyle(Q), 10);
                    if (isNaN(R))R = 0;
            ...
            ;
            var z = t.getSelection(), A = z.createBookmarks(true), B = z && z.getRanges(true), C, D = B.createIterator();
            while (C = D.getNextRange()) {
                var E = C.startContainer, F = C.endContainer, G = C.getCommonAncestor(), H = G;
                ...
                if (H) {
                    ...
                    }), K = C.startContainer, L = J.equals(K) || J.contains(K);
                    if (!(L && y(H)))w(H);
                } else x();
            }
            h.clearAllMarkers(v);
        ...
        j.add('indent', {init:function (t) {
            var u = new q(t, 'indent'), v = new q(t, 'outdent');
    ...
    (function () {
        ...
        o.prototype = {exec:function (p) {
            ...
            if (!q)return;
            var s = q.createBookmarks(), t = q.getRanges(true), u = B.cssClassName, v, w, x = p.config.useComputedState;
            x = x === undefined || x;
            for (var y = t.length - 1; y >= 0; y--) {
                ...
                while (w = v.getNextParagraph()) {
                    ...
                    var z = u && (w.$.className = e.ltrim(w.$.className.replace(B.cssClassRegex, ''))), A = B.state == 2 && (!x || m(w, true) != B.value);
                    if (u) {
                        if (A)w.addClass(u); else if (!z)w.removeAttribute('class');
    ...
    j.add('link', {init:function (l) {
        ...
        l.on('selectionChange', function (m) {
            var n = l.getCommand('unlink'), o = m.data.path.lastElement && m.data.path.lastElement.getAscendant('a', true);
        ...
        l.on('doubleclick', function (m) {
            ...
            if (n.is('a'))m.data.dialog = n.getAttribute('name') && !n.getAttribute('href') ? 'anchor' : 'link'; else if (n.is('img') && n.getAttribute('_cke_real_element_type') == 'anchor')m.data.dialog = 'anchor';
        });
    ...
    (function () {
        var l = {ol:1, ul:1}, m = /^[\n\r\t ]*$/;
        j.list = {listToArray:function (B, C, D, E, F) {
            ...
            for (var G = 0, H = B.getChildCount();
                ...
                var J = {parent:B, indent:E, element:I, contents:[]};
                if (!F) {
                ...
                for (var K = 0, L = I.getChildCount(), M; K < L; K++) {
                    M = I.getChild(K);
                    if (M.type == 1 && l[M.getName()])j.list.listToArray(M, C, D, E + 1, J.grandparent); else J.contents.push(M);
                }
            }
            return D;
            ...
            var G = B[D].parent.getDocument(), H = new d.documentFragment(G), I = null, J = D, K = Math.max(B[D].indent, 0), L = null, M = E == 1 ? 'p' : 'div';
            for (; ;) {
                var N = B[J];
                if (N.indent == K) {
                    ...
                    L;
                    if (l[N.grandparent.getName()])L = N.element.clone(false, true); else if (F || E != 2 && N.grandparent.getName() != 'td') {
                        L = G.createElement(M);
        ...
        ;
        function o(B) {
            var C = B.data.path, D = C.blockLimit, E = C.elements, F;
        ...
        ;
        function p(B, C, D, E) {
            var F = j.list.listToArray(C.root, D), G = [];
            ...
            var J = C.root, K = J.getDocument().createElement(this.type);
            J.copyAttributes(K, {start:1, type:1});
            K.removeStyle('list-style-type');
            for (H = 0; H < G.length; H++) {
                var L = G[H].getCustomData('listarray_index');
                F[L].parent = K;
            }
            var M = j.list.arrayToList(F, D, null, B.config.enterMode), N, O = M.listNode.getChildCount();
        ...
        function r(B, C, D) {
            var E = C.contents, F = C.root.getDocument(), G = [];
            ...
            var M = G[G.length - 1].getNext(), N = F.createElement(this.type), O;
            D.push(N);
            while (G.length) {
                var P = G.shift(), Q = F.createElement('li');
                if (q.test(P.getName()))P.appendTo(Q); else {
            ...
            if (M)N.insertBefore(M); else N.appendTo(I);
        }

        ;
        function s(B, C, D) {
            var E = j.list.listToArray(C.root, D), F = [];
            ...
            for (G = I + 1; G < E.length; G++) {
                if (E[G].indent > E[G - 1].indent + 1) {
                    var K = E[G - 1].indent + 1 - E[G].indent, L = E[G].indent;
            ...
            var M = j.list.arrayToList(E, D, null, B.config.enterMode, C.root.getAttribute('dir')), N = M.listNode, O, P;
        ...
        t.prototype = {exec:function (B) {
            B.focus();
            var C = B.document, D = B.getSelection(), E = D && D.getRanges(true);
            ...
            if (this.state == 2) {
                ...
                if (!F.getFirst()) {
                    ...
                    var H = E.length == 1 && E[0], I = H && H.getEnclosedNode();
                    if (I && I.is && this.type == I.getName())n.call(this, B, 1);
                }
            }
            var J = D.createBookmarks(true), K = [], L = {}, M = E.createIterator(), N = 0;
            while ((H = M.getNextRange()) && ++N) {
                var O = H.getBoundaryNodes(), P = O.startNode, Q = O.endNode;
                if (P.type == 1 && P.getName() == 'td')H.setStartAt(O.startNode, 1);
                if (Q.type == 1 && Q.getName() == 'td')H.setEndAt(O.endNode, 2);
                var R = H.createIterator(), S;
                R.forceBrBreak = this.state == 2;
                while (S = R.getNextParagraph()) {
                    if (S.getCustomData('list_block'))continue; else h.setMarker(L, S, 'list_block', 1);
                    var T = new d.elementPath(S), U = T.elements, V = U.length, W = null, X = false, Y = T.blockLimit, Z;
                    for (var aa = V - 1; aa >= 0 && (Z = U[aa]); aa--) {
                        if (l[Z.getName()] && Y.contains(Z)) {
                            ...
                            if (ab)ab.contents.push(S); else {
                                ab = {root:Z, contents:[S]};
                                K.push(ab);
                    ...
                    if (X)continue;
                    var ac = Y;
                    if (ac.getCustomData('list_group_object_' + N))ac.getCustomData('list_group_object_' + N).contents.push(S); else {
                        ab = {root:ac, contents:[S]};
            ...
            while (K.length > 0) {
                ab = K.shift();
                if (this.state == 2) {
                    if (l[ab.root.getName()])p.call(this, B, ab, L, ad); else r.call(this, B, ab, ad);
        ...
        function x(B) {
            return function (C) {
                var D = C.children, E = w(C, u.$list), F = D[E], G = F && F.previous, H;
                if (G && (G.name && G.name == 'br' || G.value && (H = G.value.match(v)))) {
                    var I = G;
                    if (!(H && H.index) && I == D[0])D[0] = B || c ? new a.htmlParser.text('\xa0') : new a.htmlParser.element('br', {}); else if (I.name == 'br')D.splice(E - 1, 1); else I.value = I.value.replace(v, '');
                }
            };
        }
        ...
        j.add('list', {init:function (B) {
            var C = new t('numberedlist', 'ol'), D = new t('bulletedlist', 'ul');
            B.addCommand('numberedlist', C);
            B.addCommand('bulletedlist', D);
            B.ui.addButton('NumberedList', {label:B.lang.numberedlist, command:'numberedlist'});
            B.ui.addButton('BulletedList', {label:B.lang.bulletedlist, command:'bulletedlist'});
    ...
    (function () {
        j.liststyle = {requires:['dialog'], init:function (l) {
            ...
            if (l.addMenuItems) {
                ...
                l.addMenuItems({numberedlist:{label:l.lang.list.numberedTitle, group:'list', command:'numberedListStyle'}, bulletedlist:{label:l.lang.list.bulletedTitle, group:'list', command:'bulletedListStyle'}});
            }
            if (l.contextMenu)l.contextMenu.addListener(function (m, n) {
                if (!m || m.isReadOnly())return null;
                while (m) {
                    var o = m.getName();
                    if (o == 'ol')return{numberedlist:2}; else if (o == 'ul')return{bulletedlist:2};
                    m = m.getParent();
                }
                return null;
            });
    ...
    (function () {
        ...
        j.add('maximize', {init:function (r) {
            var s = r.lang, t = a.document, u = t.getWindow(), v, w, x, y;

            function z() {
                var B = u.getViewPaneSize();
                y && y.setStyles({width:B.width + 'px', height:B.height + 'px'});
            ...
            r.addCommand('maximize', {modes:{wysiwyg:1, source:1}, editorFocus:false, exec:function () {
                var B = r.container.getChild(1), C = r.getThemeSpace('contents');
                if (r.mode == 'wysiwyg') {
                ...
                if (this.state == 2) {
                    ...
                    B.setStyles({left:-1 * H.x + 'px', top:-1 * H.y + 'px'});
                    b.gecko && p(r);
                ...
                this.toggleState();
                var K = this.uiItems[0], L = this.state == 2 ? s.maximize : s.minimize, M = r.element.getDocument().getById(K._.id);
    ...
    j.add('removeformat', {requires:['selection'], init:function (l) {
        ...
        l._.removeFormat = {filters:[]};
    }});
    j.removeformat = {commands:{removeformat:{exec:function (l) {
        var m = l._.removeFormatRegex || (l._.removeFormatRegex = new RegExp('^(?:' + l.config.removeFormatTags.replace(/,/g, '|') + ')$', 'i')), n = l._.removeAttributes || (l._.removeAttributes = l.config.removeFormatAttributes.split(',')), o = j.removeformat.filter, p = l.getSelection().getRanges(true), q = p.createIterator(), r;
        while (r = q.getNextRange()) {
            if (r.collapsed)continue;
            r.enlarge(1);
            var s = r.createBookmark(), t = s.startNode, u = s.endNode, v = function (y) {
                var z = new d.elementPath(y), A = z.elements;
            ...
            while (w) {
                ...
                if (!(w.getName() == 'img' && w.getAttribute('_cke_realelement')) && o(l, w))if (m.test(w.getName()))w.remove(true); else {
    ...
    j.add('resize', {init:function (l) {
        ...
        if (m.resize_enabled !== false) {
            var n = null, o, p, q = (m.resize_dir == 'both' || m.resize_dir == 'horizontal') && m.resize_minWidth != m.resize_maxWidth, r = (m.resize_dir == 'both' || m.resize_dir == 'vertical') && m.resize_minHeight != m.resize_maxHeight;

            function s(v) {
                var w = v.data.$.screenX - o.x, x = v.data.$.screenY - o.y, y = p.width, z = p.height, A = y + w * (l.lang.dir == 'rtl' ? -1 : 1), B = z + x;
    ...
    (function () {
        ...
        var o = function () {
            var s = this, t = function () {
                ...
                var C = 'scaytButton', D = window.scayt.uiTags, E = [];
            ...
            var u = s.dataProcessor, v = u && u.htmlFilter;
            if (v)v.addRules({elements:{span:function (x) {
            ...
            w.equals = e.override(w.equals, function (x) {
                return function (y) {
                    var D = this;
                    var z = D.contents, A = y.contents, B = p.getScayt(D.editor);
        ...
        j.scayt = {engineLoaded:false, instances:{}, controlInfo:{}, setControlInfo:function (s, t) {
            ...
            this.setControlInfo(s, {restored:true});
        }, setControlId:function (s, t) {
            this.setControlInfo(s, {id:t});
            ...
            this.setControlInfo(s, {paused:t});
        }, isPaused:function (s) {
            ...
            if (this.engineLoaded === true)return o.apply(s); else if (this.engineLoaded == -1)return a.on('scaytReady', function () {
                o.apply(s);
            });
            a.on('scaytReady', o, s);
            ...
            var u = 'svc.spellchecker.net/scayt25/loader__base.js', v = s.config.scayt_srcUrl || t + '//' + u, w = p.parseUrl(v).path + '/';
            if (window.scayt == undefined) {
                a._djScaytConfig = {baseUrl:w, addOnLoad:[function () {
                    a.fireOnce('scaytReady');
                }], isDebug:false};
                a.document.getHead().append(a.document.createElement('script', {attributes:{type:'text/javascript', async:'true', src:v}}));
            } else a.fireOnce('scaytReady');
            return null;
        }, parseUrl:function (s) {
            var t;
            if (s.match && (t = s.match(/(.*)[\/\\](.*?\.\w+)$/)))return{path:t[1], file:t[2]}; else return s;
        }};
        var p = j.scayt, q = function (s, t, u, v, w, x, y) {
            s.addCommand(v, w);
            s.addMenuItem(v, {label:u, command:v, group:x, order:y});
        }, r = {preserveState:true, editorFocus:false, exec:function (s) {
            if (p.isScaytReady(s)) {
        ...
        j.add('scayt', {requires:['menubutton'], beforeInit:function (s) {
            var t = s.config.scayt_contextMenuItemsOrder || 'suggest|moresuggest|control', u = '';
            t = t.split('|');
            if (t && t.length)for (var v in t)u += 'scayt_' + t[v] + (t.length != parseInt(v, 10) + 1 ? ',' : '');
            if (s.config.scayt_contextMenuOntop)s.config.menu_groups = u + ',' + s.config.menu_groups; else s.config.menu_groups = s.config.menu_groups + ',' + u;
        }, init:function (s) {
            var t = {}, u = {}, v = s.addCommand(l, r);
            a.dialog.add(l, a.getUrl(this.path + 'dialogs/options.js'));
            var w = s.config.scayt_uiTabs || '1,1,1', x = [];
            w = w.split(',');
            ...
            s.addMenuGroup(B);
            var C = {};
            C.scaytToggle = {label:s.lang.scayt.enable, command:l, group:B};
            if (x[0] == 1)C.scaytOptions = {label:s.lang.scayt.options, group:B, onClick:function () {
                m = 'options';
                s.openDialog(l);
            }};
            if (x[1] == 1)C.scaytLangs = {label:s.lang.scayt.langs, group:B, onClick:function () {
                m = 'langs';
                s.openDialog(l);
            }};
            if (x[2] == 1)C.scaytDict = {label:s.lang.scayt.dictionariesTab, group:B, onClick:function () {
                m = 'dictionaries';
                s.openDialog(l);
            }};
            C.scaytAbout = {label:s.lang.scayt.about, group:B, onClick:function () {
                m = 'about';
                s.openDialog(l);
            }};
            x[3] = 1;
            p.uiTabs = x;
            s.addMenuItems(C);
            s.ui.add('Scayt', 5, {label:s.lang.scayt.title, title:b.opera ? s.lang.scayt.opera_title : s.lang.scayt.title, className:'cke_button_scayt', onRender:function () {
                v.on('state', function () {
            ...
            if (s.contextMenu && s.addMenuItems)s.contextMenu.addListener(function (E, F) {
                ...
                var G = p.getScayt(s), H = G.getScaytNode();
                if (!H)return null;
                var I = G.getWord(H);
                if (!I)return null;
                ...
                t = {};
                u = {};
                var M = s.config.scayt_moreSuggestions || 'on', N = false, O = s.config.scayt_maxSuggestions;
                typeof O != 'number' && (O = 5);
                !O && (O = L.length);
                ...
                if (N) {
                    s.addMenuItem('scayt_moresuggest', {label:s.lang.scayt.moreSuggestions, group:'scayt_moresuggest', order:10, getItems:function () {
                        return t;
                    }});
            ...
            var D = function () {
                ...
                if (!b.opera)v.setState(p.isScaytEnabled(s) ? 1 : 2); else v.setState(0);
            };
    ...
    (function () {
        ...
        a.on('dialogDefinition', function (p) {
            ...
            if (q == 'table' || q == 'tableProperties') {
                ...
                var v = r.getContents('advanced'), w = v && v.get('advCSSClasses');
                if (w) {
    ...
    j.add('sourcearea', {requires:['editingblock'], init:function (l) {
        ...
        l.on('editingBlockReady', function () {
            ...
            l.addMode('source', {load:function (q, r) {
                ...
                o.setAttributes({dir:'ltr', tabIndex:b.webkit ? -1 : l.tabIndex, role:'textbox', 'aria-label':l.lang.editorTitle.replace('%1', l.name)});
    ...
    j.sourcearea = {commands:{source:{modes:{wysiwyg:1, source:1}, editorFocus:false, exec:function (l) {
    ...
    (function () {
        ...
        ;
        function t(F) {
            var G = [], H = F[0] && F[0].getAscendant('table'), I, J, K, L;
        ...
        function w(F) {
            if (F instanceof d.selection) {
                ...
                if (I)y(I, true); else if (H)H.remove();
            } else if (F instanceof h) {
                var K = F.getParent();
        ...
        function B(F, G, H) {
            ...
            var K, L = I[0], M = L.getAscendant('table'), N = e.buildTableMap(M), O = N.length, P = N[0].length, Q = L.getParent().$.rowIndex, R = z(N, Q, L);
            if (G) {
                var S;
                try {
        ...
        function C(F, G) {
            ...
            var I = H[0], J = I.getParent(), K = J.getAscendant('table'), L = e.buildTableMap(K), M = J.$.rowIndex, N = z(L, M, I), O = I.$.rowSpan, P, Q, R, S;
            if (O > 1) {
                Q = Math.ceil(O / 2);
                R = Math.floor(O / 2);
                S = M + Q;
        ...
        function D(F, G) {
            var H = n(F);
            if (H.length > 1)return false; else if (G)return true;
            var I = H[0], J = I.getParent(), K = J.getAscendant('table'), L = e.buildTableMap(K), M = J.$.rowIndex, N = z(L, M, I), O = I.$.colSpan, P, Q, R;
            if (O > 1) {
                Q = Math.ceil(O / 2);
                R = Math.floor(O / 2);
            } else {
        ...
        j.tabletools = {init:function (F) {
            ...
            F.addCommand('tableDelete', {exec:function (H) {
                ...
                I.selectRanges([L]);
                var M = K.getParent();
                if (M.getChildCount() == 1 && M.getName() != 'body')M.remove(); else K.remove();
            }});
    ...
    e.buildTableMap = function (l) {
        ...
        for (var p = 0; p < m.length; p++) {
            ...
            for (var r = 0; r < m[p].cells.length; r++) {
                ...
                q++;
                while (o[n][q])q++;
                var t = isNaN(s.colSpan) ? 1 : s.colSpan, u = isNaN(s.rowSpan) ? 1 : s.rowSpan;
                for (var v = 0; v < u; v++) {
                    if (!o[n + v])o[n + v] = [];
    ...
    (function () {
        var l = {editorFocus:false, modes:{wysiwyg:1, source:1}}, m = {exec:function (p) {
        ...
        function o(p) {
            return{editorFocus:false, canUndo:false, modes:{wysiwyg:1}, exec:function (q) {
                if (q.focusManager.hasFocus) {
                    var r = q.getSelection(), s = r.getCommonAncestor(), t;
                    if (t = s.getAscendant('td', true) || s.getAscendant('th', true)) {
                        var u = new d.range(q.document), v = e.tryThese(function () {
                            var C = t.getParent(), D = C.$.cells[t.$.cellIndex + (p ? -1 : 1)];
                            D.parentNode.parentNode;
                            return D;
                        }, function () {
                            var C = t.getParent(), D = C.getAscendant('table'), E = D.$.rows[C.$.rowIndex + (p ? -1 : 1)];
                            return E.cells[p ? E.cells.length - 1 : 0];
                        });
                        if (!(v || p)) {
                            var w = t.getAscendant('table').$, x = t.getParent().$.cells, y = new h(w.insertRow(-1), q.document);
        ...
        ;
        j.add('tab', {requires:['keystrokes'], init:function (p) {
            var q = p.config.enableTabKeyTools !== false, r = p.config.tabSpaces || 0, s = '';
            while (r--)s += '\xa0';
    ...
    i.undoStackSize = 20;
    (function () {
        var l = {table:1, pre:1}, m = /\s*<(p|div|address|h\d|center|li)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\1>)?\s*(?=$|<\/body>)/gi, n = d.walker.whitespaces(true);

        function o(A) {
            if (A.getType() == 3)return A.getSelectedElement().isReadOnly(); else return A.getCommonAncestor().isReadOnly();
        }
        ...
        function p(A) {
            if (this.mode == 'wysiwyg') {
                ...
                if (c) {
                    ...
                    if (D)B.unlock();
                    var E = B.getNative();
                    if (E.type == 'Control')E.clear(); else if (B.getType() == 2) {
                        var F = B.getRanges()[0], G = F && F.endContainer;
        ...
        function q(A) {
            if (this.mode == 'wysiwyg') {
                ...
                if (o(B))return;
                this.fire('saveSnapshot');
                var C = B.getRanges(), D = A.data, E = D.getName(), F = f.$block[E], G = B.isLocked;
                if (G)B.unlock();
                var H, I, J, K;
                for (var L = C.length - 1; L >= 0; L--) {
                    ...
                    if (F)while ((M = H.getCommonAncestor(false, true)) && (N = f[M.getName()]) && !(N && N[E])) {
                        if (M.getName() in f.span)H.splitElement(M); else if (H.checkStartOfBlock() && H.checkEndOfBlock()) {
                            H.setStartBefore(M);
                            H.collapse(true);
                            M.remove();
                        } else H.splitBlock();
                ...
                if (F) {
                    var O = J.getNext(n), P = O && O.type == 1 && O.getName();
        ...
        ;
        var s = d.walker.whitespaces(true), t = d.walker.bookmark(false, true);
        ...
        function y(A) {
            var B = A.window, C = A.document, D = A.document.getBody(), E = D.getChildren().count();
        ...
        ;
        function z(A) {
            var B = A.editor, C = A.data.path, D = C.blockLimit, E = A.data.selection, F = E.getRanges()[0], G = B.document.getBody(), H = B.config.enterMode;
            b.gecko && y(B);
            ...
            var L = new d.range(B.document), M = new d.walker(L);
            ...
            if (M.previous()) {
                ...
                c && w(E);
                var N;
                if (H != 2)N = G.append(new h(H == 1 ? 'p' : 'div')); else N = G;
                if (!c)N.appendBogus();
            }
        }

        ;
        j.add('wysiwygarea', {requires:['editingblock'], init:function (A) {
            var B = A.config.enterMode != 2 ? A.config.enterMode == 3 ? 'div' : 'p' : false, C = A.lang.editorTitle.replace('%1', A.name), D;
            A.on('editingBlockReady', function () {
                var J, K, L, M, N, O, P = b.isCustomDomain(), Q = function (T) {
                    if (K)K.remove();
                ...
                function S(T) {
                    ...
                    if (c) {
                        ...
                        if (b.gecko && b.version >= 10900 || b.opera)U.$.body.contentEditable = true; else if (b.webkit)U.$.body.parentNode.contentEditable = true; else U.$.designMode = 'on';
                    }, 0);
                    b.gecko && e.setTimeout(y, 0, null, A);
                    T = A.window = new d.window(T);
                    U = A.document = new g(U);
                    U.on('dblclick', function (aa) {
                        var ab = aa.data.getTarget(), ac = {element:ab, dialog:''};
                    ...
                    T.on('focus', function () {
                        var aa = A.document;
                        if (b.gecko && b.version >= 10900)H(); else if (b.opera)aa.getBody().focus();
                    ...
                    if (c) {
                        ...
                        U.on('keydown', function (aa) {
                            ...
                            if (ab in {8:1, 46:1}) {
                                var ac = A.getSelection(), ad = ac.getSelectedElement();
                                if (ad) {
                                    A.fire('saveSnapshot');
                ...
                ;
                A.addMode('wysiwyg', {load:function (T, U, V) {
                    J = T;
                    ...
                    if (V) {
                        ...
                        if (!/<head[\s|>]/.test(T))T = T.replace(/<html[^>]*>/, '$&<head><title></title></head>'); else if (!/<title[\s|>]/.test(T))T = T.replace(/<head[^>]*>/, '$&<title></title>');
                    ...
                    var T = A.config, U = T.fullPage, V = U && A.docType, W = K.getFrameDocument(), X = U ? W.getDocumentElement().getOuterHtml() : W.getBody().getHtml();
                    ...
                    if (L)M = true; else if (b.opera && A.document) {
    ...
    (function () {
        ...
        function m() {
            var Q = this;
            var M = Q._.currentTabId, N = Q._.tabIdList.length, O = e.indexOf(Q._.tabIdList, M) + N;
        ...
        function n() {
            var Q = this;
            var M = Q._.currentTabId, N = Q._.tabIdList.length, O = e.indexOf(Q._.tabIdList, M);
            for (var P = O + 1; P < O + N; P++) {
                if (l.call(Q, Q._.tabIdList[P % N]))return Q._.tabIdList[P % N];
            }
            return null;
        ...
        a.dialog = function (M, N) {
            ...
            O = e.clone(O);
            O = new t(this, O);
            var P = a.document, Q = M.theme.buildDialog(M);
            this._ = {editor:M, element:Q.element, name:N, contentSize:{width:0, height:0}, size:{width:0, height:0}, updateSize:false, contents:{}, buttons:{}, accessKeyMap:{}, tabs:{}, tabIdList:[], currentTabId:null, currentTabIndex:null, pageCount:0, lastTab:null, tabBarMode:false, focusList:[], currentFocusIndex:0, hasFocus:false};
            this.parts = Q.parts;
            e.setTimeout(function () {
            ...
            a.event.call(this);
            this.definition = O = a.fire('dialogDefinition', {name:N, definition:O}, M).definition;
            ...
            var R = this, S = function (ad) {
                var ae = R._.contents, af = false;
            ...
            this.on('ok', function (ad) {
                S(function (ae) {
                    if (ae.validate) {
                        ...
                        if (af === false) {
                            if (ae.select)ae.select(); else ae.focus();
                            ad.data.hide = false;
                            ad.stop();
                            return true;
                        }
            ...
            function T() {
                ...
                ad.sort(function (ag, ah) {
                    if (ag.tabIndex != ah.tabIndex)return ah.tabIndex - ag.tabIndex; else return ag.focusIndex - ah.focusIndex;
                });
                var ae = ad.length;
            ...
            ;
            function U(ad) {
                var ae = R._.focusList, af = ad ? 1 : -1;
                ...
                var ah = (ag + af + ae.length) % ae.length, ai = ah;
            ...
            function W(ad) {
                ...
                var ae = ad.data.getKeystroke(), af = M.lang.dir == 'rtl';
                V = 0;
                if (ae == 9 || ae == 2000 + 9) {
                    var ag = ae == 2000 + 9;
                    if (R._.tabBarMode) {
            ...
            this.on('show', function () {
                ...
                if (M.config.dialog_startupFocusTab && R._.pageCount > 1) {
                    ...
                    if (ah._.editor.mode == 'wysiwyg' && c) {
                        var ae = M.document.$.selection, af = ae.createRange();
            ...
            if (b.ie6Compat)this.on('load', function (ad) {
                var ae = this.getElement(), af = ae.getFirst();
                af.remove();
                af.appendTo(ae);
            }, this);
            v(this);
            ...
            var ab = [], ac = a.dialog._.uiElementBuilders.hbox.build(this, {type:'hbox', className:'cke_dialog_footer_buttons', widths:[], children:O.buttons}, ab).getChild();
        ...
        function o(M, N, O) {
            ...
            N.on('keydown', function (P) {
                if (P.data.getKeystroke() in {32:1, 13:1})this.fire('click');
            });
            N.on('focus', function () {
                this.fire('mouseover');
            });
        ...
        a.dialog.prototype = {destroy:function () {
            ...
            return function (M, N) {
                ...
                a.dialog.fire('resize', {dialog:O, skin:O._.editor.skinName, width:M, height:N}, O._.editor);
                O._.contentSize = {width:M, height:N};
                O._.updateSize = true;
            };
        })(), getSize:function () {
            var O = this;
            if (!O._.updateSize)return O._.size;
            var M = O._.element.getFirst(), N = O._.size = {width:M.$.offsetWidth || 0, height:M.$.offsetHeight || 0};
            ...
            return function (N, O) {
                ...
                R._.position = {x:N, y:O};
                if (!M) {
                    var Q = a.document.getWindow().getScrollPosition();
                    N += Q.x;
                    O += Q.y;
                }
                P.setStyles({left:(N > 0 ? N : 0) + 'px', top:(O > 0 ? O : 0) + 'px'});
            };
            ...
            var O = this._.element, P = this.definition;
            if (!(O.getParent() && O.getParent().equals(a.document.getBody())))O.appendTo(a.document.getBody()); else O.setStyle('display', 'block');
            ...
            if (a.dialog._.currentTop === null) {
                ...
                for (var R in {keyup:1, keydown:1, keypress:1})O.on(R, L);
            } else {
            ...
            e.setTimeout(function () {
                var T = a.document.getWindow().getViewPaneSize(), U = this.getSize();
            ...
            if (!this._.parentDialog) {
                ...
                for (var O in {keyup:1, keydown:1, keypress:1})M.removeListener(O, L);
                var P = this._.editor;
                P.focus();
                if (P.mode == 'wysiwyg' && c) {
            ...
            var Y = this;
            var N = [], O = M.label ? ' title="' + e.htmlEncode(M.label) + '"' : '', P = M.elements, Q = a.dialog._.uiElementBuilders.vbox.build(Y, {type:'vbox', className:'cke_dialog_page_contents', children:M.elements, expand:!!M.expand, padding:M.padding, style:M.style || 'width: 100%; height: 100%;'}, N), R = h.createFromHtml(N.join(''));
            R.setAttribute('role', 'tabpanel');
            var S = b, T = 'cke_' + M.id + '_' + e.getNextNumber(), U = h.createFromHtml(['<a class="cke_dialog_tab"', Y._.pageCount > 0 ? ' cke_last' : 'cke_first', O, !!M.hidden ? ' style="display:none"' : '', ' id="', T, '"', S.gecko && S.version >= 10900 && !S.hc ? '' : ' href="javascript:void(0)"', ' tabIndex="-1"', ' hidefocus="true"', ' role="tab">', M.label, '</a>'].join(''));
            ...
            Y._.lastTab = U;
            Y.updateStyle();
            var V = Y._.contents[M.id] = {}, W, X = Q.getChild();
            while (W = X.shift()) {
                V[W.id] = W;
            ...
            if (R.fire('selectPage', {page:M, currentPage:R._.currentTabId}) === true)return;
            for (var N in R._.tabs) {
                var O = R._.tabs[N][0], P = R._.tabs[N][1];
                if (N != M) {
            ...
            if (!N || O._.pageCount == 1)return; else if (M == O._.currentTabId)O.selectPage(m.call(O));
            N.hide();
            O._.pageCount--;
            O.updateStyle();
        }, showPage:function (M) {
        ...
        e.extend(a.dialog, {add:function (M, N) {
            ...
            var M = function (N, O) {
                O = O || {};
                return e.extend({id:'ok', type:'button', label:N.lang.common.ok, 'class':'cke_dialog_ui_button_ok', onClick:function (P) {
                    var Q = P.data.dialog;
                    if (Q.fire('ok', {hide:true}).hide !== false)Q.hide();
                }}, O, true);
            };
            M.type = 'button';
            ...
            var M = function (N, O) {
                O = O || {};
                return e.extend({id:'cancel', type:'button', label:N.lang.common.cancel, 'class':'cke_dialog_ui_button_cancel', onClick:function (P) {
                    var Q = P.data.dialog;
                    if (Q.fire('cancel', {hide:true}).hide !== false)Q.hide();
                }}, O, true);
            };
            M.type = 'button';
            M.override = function (N) {
        ...
        t.prototype = {getContents:function (M) {
        ...
        function v(M) {
            var N = null, O = null, P = M.getElement().getFirst(), Q = M.getParentEditor(), R = Q.config.dialog_magnetDistance, S = Q.skin.margins || [0, 0, 0, 0];
            if (typeof R == 'undefined')R = 20;
            function T(V) {
                var W = M.getSize(), X = a.document.getWindow().getViewPaneSize(), Y = V.data.$.screenX, Z = V.data.$.screenY, aa = Y - N.x, ab = Z - N.y, ac, ad;
                N = {x:Y, y:Z};
                O.x += aa;
                O.y += ab;
                if (O.x + S[3] < R)ac = -S[3]; else if (O.x - S[1] > X.width - W.width - R)ac = X.width - W.width + S[1]; else ac = O.x;
                if (O.y + S[0] < R)ad = -S[0]; else if (O.y - S[2] > X.height - W.height - R)ad = X.height - W.height + S[2]; else ad = O.y;
                M.move(ac, ad);
            ...
            M.parts.title.on('mousedown', function (V) {
                M._.updateSize = true;
                N = {x:V.data.$.screenX, y:V.data.$.screenY};
        ...
        ;
        function w(M) {
            var N = M.definition, O = N.minWidth || 0, P = N.minHeight || 0, Q = N.resizable, R = M.getParentEditor().skin.margins || [0, 0, 0, 0];
            ...
            ;
            var W = null, X = null, Y = M._.editor.config.magnetDistance, Z = ['tl', 't', 'tr', 'l', 'r', 'bl', 'b', 'br'];

            function aa(ad) {
                var ae = ad.listenerData.part, af = M.getSize();
                X = M.getPosition();
                e.extend(X, {x2:X.x + af.width, y2:X.y + af.height});
                W = {x:ad.data.$.screenX, y:ad.data.$.screenY};
                a.document.on('mousemove', ab, M, {part:ae});
                a.document.on('mouseup', ac, M, {part:ae});
                if (b.ie6Compat) {
                    var ag = z.getChild(0).getFrameDocument();
                    ag.on('mousemove', ab, M, {part:ae});
                    ag.on('mouseup', ac, M, {part:ae});
                }
                ad.data.preventDefault();
            }
            ...
            ;
            function ab(ad) {
                var ae = ad.data.$.screenX, af = ad.data.$.screenY, ag = ae - W.x, ah = af - W.y, ai = a.document.getWindow().getViewPaneSize(), aj = ad.listenerData.part;
                ...
                W = {x:ae, y:af};
                var ak, al, am, an;
                if (X.x + R[3] < Y)ak = -R[3]; else if (aj.search('l') != -1 && X.x2 - X.x < O + Y)ak = X.x2 - O; else ak = X.x;
                if (X.y + R[0] < Y)al = -R[0]; else if (aj.search('t') != -1 && X.y2 - X.y < P + Y)al = X.y2 - P; else al = X.y;
                if (X.x2 - R[1] > ai.width - Y)am = ai.width + R[1]; else if (aj.search('r') != -1 && X.x2 - X.x < O + Y)am = X.x + O; else am = X.x2;
                if (X.y2 - R[2] > ai.height - Y)an = ai.height + R[2]; else if (aj.search('b') != -1 && X.y2 - X.y < P + Y)an = X.y + P; else an = X.y2;
                M.move(ak, al);
        ...
        function A(M) {
            var N = a.document.getWindow(), O = M.config.dialog_backgroundCoverColor || 'white', P = M.config.dialog_backgroundCoverOpacity, Q = M.config.baseFloatZIndex, R = e.genKey(O, P, Q), S = y[R];
            if (!S) {
                ...
                if (b.ie6Compat) {
                    var U = b.isCustomDomain(), V = "<html><body style=\\'background-color:" + O + ";\\'></body></html>";
            ...
            var W = function () {
                ...
                S.setStyles({width:Z.width + 'px', height:Z.height + 'px'});
            }, X = function () {
                var Z = N.getScrollPosition(), aa = a.dialog._.currentTop;
                S.setStyles({left:Z.x + 'px', top:Z.y + 'px'});
                do {
        ...
        ;
        var D = {}, E = function (M) {
            var N = M.data.$.ctrlKey || M.data.$.metaKey, O = M.data.$.altKey, P = M.data.$.shiftKey, Q = String.fromCharCode(M.data.$.keyCode), R = D[(N ? 'CTRL+' : '') + (O ? 'ALT+' : '') + (P ? 'SHIFT+' : '') + Q];
            ...
            var R = D[O] || (D[O] = []);
            R.push({uiElement:M, dialog:N, key:O, keyup:Q || M.accessKeyUp, keydown:P || M.accessKeyDown});
        }, H = function (M) {
            for (var N in D) {
                var O = D[N];
        ...
        }, K = {27:1, 13:1}, L = function (M) {
            if (M.data.getKeystroke() in K)M.data.stopPropagation();
        };
        (function () {
            k.dialog = {uiElement:function (M, N, O, P, Q, R, S) {
                if (arguments.length < 4)return;
                var T = (P.call ? P(N) : P) || 'div', U = ['<', T, ' '], V = (Q && Q.call ? Q(N) : Q) || {}, W = (R && R.call ? R(N) : R) || {}, X = (S && S.call ? S.call(this, M, N) : S) || '', Y = this.domId = W.id || e.getNextId() + '_uiElement', Z = this.id = N.id, aa;
                W.id = Y;
                var ab = {};
                ...
                if (arguments.length < 4)return;
                this._ || (this._ = {});
                var R = this._.children = N, S = Q && Q.widths || null, T = Q && Q.height || null, U = {}, V, W = function () {
                    var Y = ['<tbody><tr class="cke_dialog_ui_hbox">'];
                    for (V = 0; V < O.length; V++) {
                        var Z = 'cke_dialog_ui_hbox_child', aa = [];
                ...
                k.dialog.uiElement.call(this, M, Q || {type:'hbox'}, P, 'table', U, X, W);
            }, vbox:function (M, N, O, P, Q) {
                if (arguments.length < 3)return;
                this._ || (this._ = {});
                var R = this._.children = N, S = Q && Q.width || null, T = Q && Q.heights || null, U = function () {
                    ...
                    for (var W = 0; W < O.length;
                        ...
                        if (T)X.push('height:' + e.cssLength(T[W])); else if (Q && Q.expand)X.push('height:' + Math.floor(100 / O.length) + '%');
                ...
                k.dialog.uiElement.call(this, M, Q || {type:'vbox'}, P, 'div', null, {role:'presentation'}, U);
            }};
        })();
        k.dialog.uiElement.prototype = {getElement:function () {
            ...
            var N = /^on([A-Z]\w+)/, O, P = function (R, S, T, U) {
                S.on('load', function () {
            ...
            for (var Q in M) {
                ...
                if (this.eventProcessors[Q])this.eventProcessors[Q].call(this, this._.dialog, M[Q]); else P(this, this._.dialog, O[1].toLowerCase(), M[Q]);
            }
            return this;
        }, eventProcessors:{onLoad:function (M, N) {
            M.on('load', N, this);
        }, onShow:function (M, N) {
            M.on('show', N, this);
        }, onHide:function (M, N) {
        ...
        k.dialog.hbox.prototype = e.extend(new k.dialog.uiElement(), {getChild:function (M) {
            var N = this;
            if (arguments.length < 1)return N._.children.concat();
            if (!M.splice)M = [M];
            if (M.length < 2)return N._.children[M[0]]; else return N._.children[M[0]] && N._.children[M[0]].getChild ? N._.children[M[0]].getChild(M.slice(1, M.length)) : null;
        }}, true);
        k.dialog.vbox.prototype = new k.dialog.hbox();
        (function () {
            var M = {build:function (N, O, P) {
                var Q = O.children, R, S = [], T = [];
        ...
        a.dialogCommand.prototype = {exec:function (M) {
        ...
        (function () {
            ...
            a.dialog.validate = {functions:function () {
                return function () {
                    var V = this;
                    var P = V && V.getValue ? V.getValue() : arguments[0], Q = undefined, R = 2, S = [], T;
                    for (T = 0; T < arguments.length; T++) {
                        if (typeof arguments[T] == 'function')S.push(arguments[T]); else break;
                    }
                    ...
                    for (T = 0; T < S.length; T++) {
                        if (R == 2)U = U && S[T](P); else U = U || S[T](P);
                    }
                    if (!U) {
                ...
                return function () {
                    ...
                    if (!P.test(R)) {
                        if (Q !== undefined)alert(Q);
                        if (S && (S.select || S.focus))if (S.select)S.select(); else S.focus();
                        return false;
                    }
                    return true;
                };
    ...
    (function () {
        ...
        a.style.prototype = {apply:function (O) {
            N.call(this, O, false);
        }, remove:function (O) {
            N.call(this, O, true);
            ...
            var O = this._.definition, P = [], Q = O.element;
            if (Q == 'bdo')Q = 'span';
            P = ['<', Q];
            var R = O.attributes;
        ...
        a.style.getStyleText = function (O) {
            ...
            if (P)return P;
            P = O.styles;
            var Q = O.attributes && O.attributes.style || '', R = '';
            if (Q.length)Q = Q.replace(n, ';');
            for (var S in P) {
                var T = P[S], U = (S + ':' + T).replace(n, ';');
                if (T == 'inherit')R += U; else Q += U;
            }
            if (Q.length)Q = K(Q);
            Q += R;
            return O._ST = Q;
        ...
        function o(O) {
            ...
            var R = ak.element, S = ak._.definition, T, U = f[R] || (T = true, f.span);
            O.enlarge(1);
            O.trim();
            var V = O.createBookmark(), W = V.startNode, X = V.endNode, Y = W, Z;
            while (Y) {
                var aa = false;
                if (Y.equals(X)) {
                    Y = null;
                    ...
                    var ab = Y.type, ac = ab == 1 ? Y.getName() : null;
                ...
                if (aa && Z && !Z.collapsed) {
                    var ag = D(ak, P), ah = Z.getCommonAncestor();
                    while (ag && ah) {
                        if (ah.getName() == R) {
        ...
        function p(O) {
            O.enlarge(1);
            var P = O.createBookmark(), Q = P.startNode;
            if (O.collapsed) {
                var R = new d.elementPath(Q.getParent()), S;
                ...
                if (S) {
                    ...
                    for (T = 0; true; T++) {
                        var X = R.elements[T];
                        if (X.equals(S))break; else if (X.match)continue; else X = X.clone();
                        X.append(W);
                        W = X;
                    }
                ...
                var Y = P.endNode, Z = this;

                function aa() {
                    var ad = new d.elementPath(Q.getParent()), ae = new d.elementPath(Y.getParent()), af = null, ag = null;
                ...
                while (!ab.equals(Y)) {
                    ...
                    if (ab.type == 1 && this.checkElementRemovable(ab)) {
                        if (ab.getName() == this.element)z(this, ab); else B(ab, I(this)[ab.getName()]);
        ...
        ;
        function q(O) {
            var P = O.getCommonAncestor(true, true), Q = P.getAscendant(this.element, true);
            Q && E(Q, this);
        }

        ;
        function r(O) {
            var P = O.createBookmark(true), Q = O.createIterator();
            Q.enforceRealBlocks = true;
            if (this._.enterMode)Q.enlargeBr = this._.enterMode != 2;
            var R, S = O.document, T;
        ...
        ;
        function s(O, P) {
            var Q = P.is('pre'), R = O.is('pre'), S = Q && !R, T = !Q && R;
            if (S)P = y(O, P); else if (T)P = x(v(O), P); else O.moveChildren(P);
            P.replace(O);
            if (Q)u(P);
        }
        ...
        function u(O) {
            ...
            var Q = w(P.getHtml(), /\n$/, '') + '\n\n' + w(O.getHtml(), /^\n/, '');
            if (c)O.$.outerHTML = '<pre>' + Q + '</pre>'; else O.setHtml(Q);
            P.remove();
        }

        ;
        function v(O) {
            var P = /(\S\s*)\n(?:\s|(<span[^>]+_fck_bookmark.*?\/span>))*\n(?!$)/gi, Q = O.getName(), R = w(O.getOuterHtml(), P, function (T, U, V) {
                return U + '</pre>' + V + '<pre>';
            }), S = [];
        ...
        function x(O, P) {
            ...
            for (var R = 0; R < O.length; R++) {
                ...
                S = w(S, /^[ \t]+|[ \t]+$/g, function (U, V, W) {
                    if (U.length == 1)return '&nbsp;'; else if (!V)return e.repeat('&nbsp;', U.length - 1) + ' '; else return ' ' + e.repeat('&nbsp;', U.length - 1);
                });
                S = S.replace(/\n/g, '<br>');
        ...
        ;
        function z(O, P) {
            var Q = O._.definition, R = e.extend({}, Q.attributes, I(O)[P.getName()]), S = Q.styles, T = e.isEmpty(R) && e.isEmpty(S);
            for (var U in R) {
        ...
        ;
        function A(O, P) {
            var Q = O._.definition, R = Q.attributes, S = Q.styles, T = I(O), U = P.getElementsByTag(O.element);
        ...
        ;
        function D(O, P) {
            var Q, R = O._.definition, S = O.element;
            if (S == '*')S = 'span';
            Q = new h(S, P);
            return E(Q, O);
        }
        ...
        ;
        function E(O, P) {
            var Q = P._.definition, R = Q.attributes, S = a.style.getStyleText(Q);
        ...
        function I(O) {
            ...
            var P = O._.overrides = {}, Q = O._.definition.overrides;
            if (Q) {
                if (!e.isArray(Q))Q = [Q];
                for (var R = 0; R < Q.length; R++) {
                    var S = Q[R], T, U, V;
                    if (typeof S == 'string')T = S.toLowerCase(); else {
        ...
        ;
        function N(O, P) {
            var Q = O.getSelection(), R = Q.createBookmarks(), S = Q.getRanges(true), T = P ? this.removeFromRange : this.applyToRange, U, V = S.createIterator();
    ...
    (function () {
        ...
        l.prototype = {getNextParagraph:function (o) {
            ...
            while (A) {
                ...
                if (!C) {
                    var E = A.getName();
                    if (A.isBlockBoundary(N.forceBrBreak && {br:1})) {
                ...
                if (q && !B)while (!A.getNext() && !r) {
                    var F = A.getParent();
                    if (F.isBlockBoundary(N.forceBrBreak && {br:1})) {
                        B = true;
                        r = r || F.equals(w);
                        break;
                    }
            ...
            if (!p) {
                ...
                var G = new d.elementPath(q.startContainer), H = G.blockLimit, I = {div:1, th:1, td:1};
                p = G.block;
                if (!p && !N.enforceRealBlocks && I[H.getName()] && q.checkStartOfBlock() && q.checkEndOfBlock())p = H; else if (!p || N.enforceRealBlocks && p.getName() == 'li') {
            ...
            if (s) {
                var K = p.getPrevious();
                if (K && K.type == 1)if (K.getName() == 'br')K.remove(); else if (K.getLast() && K.getLast().$.nodeName.toLowerCase() == 'br')K.getLast().remove();
            }
            if (t) {
                var L = d.walker.bookmark(false, true), M = p.getLast();
    ...
    (function () {
        ...
        k.floatPanel = e.createClass({$:function (o, p, q, r) {
            ...
            v.setStyles({top:'-30000px', display:''});
            v.setOpacity(0);
            ...
            e.setTimeout(function () {
                ...
                var D = e.bind(function () {
                    ...
                    v.setStyles({top:B + 'px', left:A + 'px'});
                    v.setOpacity(1);
                }, this);
    ...
    (function () {
        ...
        j.add('selection', {init:function (s) {
            s.on('contentDom', function () {
                var t = s.document, u = t.getBody(), v = t.getDocumentElement();
                if (c) {
                    var w, x, y = 1;
                    ...
                    function A(B) {
                        if (x) {
                            var C = s.document, D = s.getSelection(), E = D && D.getNative();
                            if (B && E && E.type == 'None')if (!C.$.queryCommandEnabled('InsertImage')) {
                                e.setTimeout(A, 50, this, true);
                                return;
                            }
                            var F;
                            if (E && E.type && E.type != 'Control' && (F = E.createRange()) && (F = F.parentElement()) && (F = F.nodeName) && F.toLowerCase() in {input:1, textarea:1})return;
                            w = E && D.getRanges()[0];
                            o.call(s);
                        }
                    }
        ...
        d.selection.prototype = {getNative:c ? function () {
            ...
            var s = c ? (function () {
                var t = function (u, v) {
                    u = u.duplicate();
                    u.collapse(v);
                    var w = u.parentElement(), x = w.childNodes, y;
                    for (var z = 0; z < x.length; z++) {
                        var A = x[z];
                        if (A.nodeType == 1) {
                            y = u.duplicate();
                            y.moveToElementText(A);
                            var B = y.compareEndPoints('StartToStart', u), C = y.compareEndPoints('EndToStart', u);
                            y.collapse();
                            if (B > 0)break; else if (!B || C == 1 && B == -1)return{container:w, offset:z};
                            else if (!C)return{container:w, offset:z + 1};
                            y = null;
                        }
                    }
                    if (!y) {
                    ...
                    if (D === 0)return{container:w, offset:z}; else return{container:x[z], offset:-D};
                };
                return function () {
                    var E = this;
            ...
            return function (t) {
                var u = this._.cache;
                if (u.ranges && !t)return u.ranges; else if (!u.ranges)u.ranges = new d.rangeList(s.call(this));
                if (t) {
                    var v = u.ranges;
                    for (var w = 0; w < v.length; w++) {
                        var x = v[w], y = x.getCommonAncestor();
                        if (y.isReadOnly())v.splice(w, 1);
                        if (x.collapsed)continue;
                        var z = x.startContainer, A = x.endContainer, B = x.startOffset, C = x.endOffset, D = x.clone(), E;
                        if (E = z.isReadOnly())x.setStartAfter(E);
                        if (z && z.type == 3)if (B >= z.getLength())D.setStartAfter(z); else D.setStartBefore(z);
                        if (A && A.type == 3)if (!C)D.setEndBefore(A); else D.setEndAfter(A);
            ...
            if (c) {
                ...
                for (var v = 0; v < s.length; v++) {
                    ...
                    var z = s[v], A = C.document.$.createRange(), B = z.startContainer;
    ...
    (function () {
        var l = d.walker.whitespaces(true), m = /\ufeff|\u00a0/, n = {table:1, tbody:1, tr:1};
        d.range.prototype.select = c ? function (o) {
            var y = this;
            var p = y.collapsed, q, r;
            ...
            var s = y.createBookmark(), t = s.startNode, u;
            if (!p)u = s.endNode;
    ...
    a.editor.prototype.createFakeElement = function (l, m, n, o) {
        var p = this.lang.fakeobjects, q = {'class':m, src:a.getUrl('images/spacer.gif'), _cke_realelement:encodeURIComponent(l.getOuterHtml()), _cke_real_node_type:l.type, alt:p[n] || p.unknown, align:l.getAttribute('align') || ''};
    ...
    a.editor.prototype.createFakeParserElement = function (l, m, n, o) {
        ...
        l.writeHtml(r);
        q = r.getHtml();
        var s = {'class':m, src:a.getUrl('images/spacer.gif'), _cke_realelement:encodeURIComponent(q), _cke_real_node_type:l.type, alt:p[n] || p.unknown, align:l.attributes.align || ''};
    ...
    (function () {
        ...
        e.extend(k.dialog, {labeledElement:function (t, u, v, w) {
            ...
            var y = this._.children = [], z = function () {
                var A = [], B = u.required ? ' cke_required' : '';
                if (u.labelLayout != 'horizontal')A.push('<label class="cke_dialog_ui_labeled_label' + B + '" ', ' id="' + x.labelId + '"', ' for="' + x.inputId + '"', ' style="' + u.labelStyle + '">', u.label, '</label>', '<div class="cke_dialog_ui_labeled_content" role="presentation">', w.call(this, t, u), '</div>'); else {
                    var C = {type:'hbox', widths:u.widths, padding:0, children:[
                        {type:'html', html:'<label class="cke_dialog_ui_labeled_label' + B + '"' + ' id="' + x.labelId + '"' + ' for="' + x.inputId + '"' + ' style="' + u.labelStyle + '">' + e.htmlEncode(u.label) + '</span>'},
            ...
            if (arguments.length < 3)return;
            l.call(this, u);
            var w = this._.inputId = e.getNextId() + '_textInput', x = {'class':'cke_dialog_ui_input_' + u.type, id:w, type:'text'}, y;
            ...
            if (arguments.length < 3)return;
            l.call(this, u);
            var w = this, x = this._.inputId = e.getNextId() + '_textarea', y = {};
            if (u.validate)this.validate = u.validate;
            y.rows = u.rows || 5;
            y.cols = u.cols || 20;
            var z = function () {
            ...
            if (u.validate)this.validate = u.validate;
            var x = function () {
                var y = e.extend({}, u, {id:u.id ? u.id + '_checkbox' : e.getNextId() + '_checkbox'}, true), z = [], A = e.getNextId() + '_label', B = {'class':'cke_dialog_ui_checkbox_input', type:'checkbox', 'aria-labelledby':A};
                s(y);
            ...
            var w = [], x = this, y = function () {
                var z = [], A = [], B = {'class':'cke_dialog_ui_radio_item', 'aria-labelledby':this._.labelId}, C = u.id ? u.id + '_radio' : e.getNextId() + '_radio';
                for (var D = 0; D < u.items.length; D++) {
                    var E = u.items[D], F = E[2] !== undefined ? E[2] : E[0], G = E[1] !== undefined ? E[1] : E[0], H = e.getNextId() + '_radio_input', I = H + '_label', J = e.extend({}, u, {id:H, title:null, type:null}, true), K = e.extend({}, J, {title:F}, true), L = {type:'radio', 'class':'cke_dialog_ui_radio_input', name:C, value:G, 'aria-labelledby':I}, M = [];
            ...
            t.on('load', function (z) {
                ...
                (function () {
                    ...
                    A.on('keydown', function (B) {
                        if (B.data.getKeystroke() in {32:1}) {
                            w.click();
                            B.data.preventDefault();
                        }
                    });
            ...
            var x = function () {
                var y = e.extend({}, u, {id:u.id ? u.id + '_select' : e.getNextId() + '_select'}, true), z = [], A = [], B = {id:w.inputId, 'class':'cke_dialog_ui_input_select', 'aria-labelledby':this._.labelId};
        ...
        k.dialog.radio.prototype = e.extend(new k.dialog.uiElement(), {setValue:function (t, u) {
            var v = this._.children, w;
        ...
        k.dialog.file.prototype = e.extend(new k.dialog.labeledElement(), p, {getInputElement:function () {
            ...
            var u = /^on([A-Z]\w+)/, v, w = function (y, z, A, B) {
            ...
            for (var x in t) {
                ...
                if (this.eventProcessors[x])this.eventProcessors[x].call(this, this._.dialog, t[x]); else w(this, this._.dialog, v[1].toLowerCase(), t[x]);
            }
            return this;
        }, reset:function () {
            var t = a.document.getById(this._.frameId), u = t.getFrameDocument(), v = this._.definition, w = this._.buttons, x = this.formLoadedNumber, y = this.formUnloadNumber, z = this._.dialog._.editor.lang.dir, A = this._.dialog._.editor.langCode;
            if (!x) {
            ...
            ;
            if (b.gecko)setTimeout(B, 500); else B();
        }, getValue:function () {
