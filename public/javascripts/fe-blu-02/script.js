...
jQuery(function ($) {
    ...
    var bgimages = "url('images/object2039707546.png'),url('images/object1574042136.png'),url('images/object1693035232.png'), ".split(",");
    var bgpositions = "71px 18px,99px 8px,355px 8px, ".split(",");
